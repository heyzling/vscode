...
export class ViewModel extends Disposable implements IViewModel {
	...
	constructor(
		...
		if (USE_IDENTITY_LINES_COLLECTION && this.model.isTooLargeForTokenization()) {
			...
			const conceal = options.get(EditorOption.conceal);
	...
	private _onConfigurationChanged(eventsCollector: ViewModelEventsCollector, e: ConfigurationChangedEvent): void {
		...
		if (this._lines.setWrappingSettings(fontInfo, wrappingStrategy, wrappingInfo.wrappingColumn, wrappingIndent, wordBreak, conceal)) {
